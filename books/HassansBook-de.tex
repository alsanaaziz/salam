...
Wann immer ich das Zentrum danach besuchte,
konnte ich nicht anders, als ‚Finde Jesus‘ zu spielen.
...
ein Bassist, Schlagzeuger und Keyboarder spielten.
...
aber etwas stimmt nicht ganz mit religiösen Liedern wie diese –
...
und rosa Turnschuhen trug, begann wild herumzutanzen,
während ein dicker, afrikanischer Mann sich vor mir
auf der Stelle drehte und dramatischerweise in die Luft zeigte,
und jedem einen jubelnden Blick gab.*
...
Beispielsweise sieht man wie das arabische Wort Allah
an der Seite eines Fisches, auf dem Rücken einer Kuh
oder im Inneren von Obst und Gemüse geschrieben steht.
Mir wurde einmal ein Bild von einer halbierten Aubergine gegeben.

Der Text unter dem Bild erklärte:
„Das Wort Allah klar zu sehen, in der Mitte geschrieben.“

Anders als das Wort Allah auf der Sohle eines Nike-Schuhs geschrieben,
das war es von Gott selbst, und so statt Sakrileg,
es war gelegt eine wunderbare Bestätigung für die Wahrheit des Islam,

auch wenn man versehentlich essen würde.
...
konnte es mir aber verkneifen und wartete darauf, dass jemand etwas sagte.
...
\begin{quote}
„Rashid, Ich glaube wirklich nicht, dass das ein echtes Bild ist.“
...
Als ich also einen freien Moment hatte,
...
Muslime sind auch fixiert auf Konvertiten, und Namen wie Muhammad Ali,
Malcolm X, Yusuf Islam, Jermaine Jackson und Chris Eubank
werden erwähnt, so als wolle man sagen: „Siehst du, der Islam ist wahr!“
...
Taliban-Kämpfer, Adam Gadahn, Sprecher für Al\–Qa\`idah,
...
Mir wurde das schon etliche Male gesagt – in Flüsterstimme natürlich,
um es geheimzuhalten.
...
Man möchte meinen, dass wir uns nach fünfundzwanzig Jahren geändert haben sollten!“*
...
„Ihr seid alles Individuen!“ sagte John –
