...
Qur’an and the Prophetic Rhetoric.” Page 160.}
...
\footnotetext{Al-Baghdadi, “The Difference Between the Groups” Page 164–165; and
...
\footnotetext{All the quotes are taken from the previous reference, p. 133 with
some slight edits in wording but not meaning.}
...
\footnotetext{(11) Quoted from Dr. Abd al Rahman Badawi, from “History of
...
\footnotetext{(12) See: The previous reference, page 87, 186 and that which is
after it.}
...
\footnotetext{(13) Quote from the previous reference p 112 and 182.}
...
\footnotetext{(14) Quote from the pervious reference p. 186–187.}
...
\footnotetext{(15) Quote from the pervious reference p. 84.}
...
\footnotetext{(16) Quote from the pervious reference 101–102. Abu Qubais and
...
\footnotetext{(17) Quote from the previous reference p 87.}
...
\footnotetext{(18) Quote from the previous reference p 87.}
...
\footnotetext{(19) Quote from the previous reference p 110.}
...
\footnotetext{(20) Quote from the previous reference p 111.}
...
\footnotetext{(21) Quote from the previous reference p 120.}
...
\footnotetext{(22) Quote from the previous reference p 133.}
...
\footnotetext{(23) Quote from the previous reference p 216.}
...
\footnotetext{(24) Quote from the previous reference p 119 and 153.}
...
\footnotetext{(25) Al Baghdadi, “The Difference Between the Groups”, p 132;
See also p 149–150}
