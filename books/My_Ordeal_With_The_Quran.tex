...
\def \Quran{Qurʾān} % Used when followed by punctuation mark.
\def \Qrn{\Quran}   % Used when followed by whitespace.
...
(الثَنْدَوَة is the flesh between the nipples.)}
...
% Doesn't have a number in the original.
