...
\def\fnmarksym[#1]{\renewcommand{\thefootnote}{#1}\footnotemark%
\addtocounter{footnote}{-1}}
\def\fntextsym#1{\footnotetext{#1}\renewcommand{\thefootnote}{\oldtfn}}
...
than many of the \Qrn{}ic verses that are of nonsensical language,
